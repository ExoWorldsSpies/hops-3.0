...
class Databases:
    ...
    def __init__(self, update=False):
        ...
        self.clablimb = Database('clablimb', 'hops30pylightcurve3', __file__, date_to_update='200228',
                                 update=update).path
        self.ephemeris = Database('ephemeris', 'hops30pylightcurve3', __file__, date_to_update='200228',
                                  frequencey=30, update=update).path
        self.oec = Database('oec', 'hops30pylightcurve3', __file__, date_to_update='200228', frequencey=30,
                            update=update).path
